...
int pos=60;             //Variable to store the servo position. By default 90 degrees - sensor will 'look' forward
...
void loop()
{
  ...
  if (function == 0){   //If button is unpressed or pressed twice then:
    myservo.write(60);    //set servo 90 degress - sensor will look forward
    ...
    if (distance > 15){
      ...
      for(pos = 0; pos < 120; pos += 1){  //goes from 0 degrees to 120 degrees 
            ...
            myservo.write(60);                   // Sensor "look" forward again
